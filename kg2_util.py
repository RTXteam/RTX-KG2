...
import validators
import yaml
from typing import Dict, Optional, TypeVar, Union, Any, Iterable, cast
from decimal import *
...
EDGE_LABEL_BIOLINK_AFFECTS = 'affects'
EDGE_LABEL_BIOLINK_HAS_INPUT = 'has_input'
EDGE_LABEL_BIOLINK_MAY_BE_TREATED_BY = 'may_be_treated_by'
EDGE_LABEL_BIOLINK_COEXISTS_WITH = 'coexists_with'
EDGE_LABEL_BIOLINK_MAY_TREAT = 'may_treat'
