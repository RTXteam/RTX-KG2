...
TARGET_TYPE_TO_CATEGORY = {
    ...
    'PROTEIN COMPLEX': kg2_util.BIOLINK_CATEGORY_MACROMOLECULAR_COMPLEX,
    'PROTEIN COMPLEX GROUP': kg2_util.BIOLINK_CATEGORY_MACROMOLECULAR_COMPLEX,
    'PROTEIN FAMILY': kg2_util.BIOLINK_CATEGORY_GENE_FAMILY,
    'PROTEIN NUCLEIC-ACID COMPLEX': kg2_util.BIOLINK_CATEGORY_MACROMOLECULAR_COMPLEX,
