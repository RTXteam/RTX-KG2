...
(1) First, you need to add a rule for the extraction script (most are structured in the form 'extract-{database name}.sh').
...
(2) Then, you will need to add a rule for the conversion (which converts the data into KG2's format).
